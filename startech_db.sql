...
--
-- Hôte : localhost
-- Généré le : jeu. 20 nov. 2025 à 15:23
...
(2, 'Zdlm', 'Leila', 'zdlmleila@gmail.com', '$2y$10$u30tGXF8mhOT6UntWYvC2.xi2C67tuzwFigC2nlEW2DLlObHGwNbu', 'client', NULL, NULL, NULL, NULL, '2025-11-18 15:38:21', NULL, 'client', NULL),
...
INSERT INTO `produits` (`id`, `nom`, `description`, `prix_achat_moyen`, `prix_vente`, `quantite_stock`, `seuil_alerte_stock`, `unite_mesure`, `categorie_id`, `fournisseur_principal_id`, `image_url`, `prix_achat_ht`, `prix_vente_ht`, `seuil_alerte`, `statut`, `image`, `fournisseur_id`) VALUES
